...
def configure_from_args() -> None:
    ...
    for argument in ("catalog", "schema", "volume", "medicaid-states", "medicaid-years",
                     "cms-mode", "max-openfda-products", "pg-host", "pg-database", "pg-port", "pg-sslmode",
    ...
    mapping = {
        ...
        "cms_mode": "CMS_MODE", "max_openfda_products": "MAX_OPENFDA_PRODUCTS",
        "pg_host": "PGHOST", "pg_database": "PGDATABASE",
