...
2. **Exact decomposition:** “For Mounjaro in Texas in Q4 2025, break the YoY reimbursement change into prescription-volume and reimbursement-per-prescription effects.” Expected: `get_product_performance`, `decompose_reimbursement_change`.
3. **Geography:** “Which selected states contributed most to the 2025 reimbursement change for Trulicity?” Expected: `get_product_performance`, `get_variance_drivers`.
